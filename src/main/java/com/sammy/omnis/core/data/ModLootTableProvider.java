...
public class ModLootTableProvider extends LootTableProvider
{
    ...
    {
        return LootTable.builder().addLootPool(withExplosionDecay(vexWart, LootPool.builder()
                .rolls(ConstantRange.of(1))
                .addEntry(ItemLootEntry.builder(item)
                        .acceptCondition(BlockStateProperty.builder(vexWart).fromProperties(StatePropertiesPredicate.Builder.newBuilder().withIntProp(VexwartBlock.AGE, 0))))
                .addEntry(ItemLootEntry.builder(item)
                        .acceptCondition(BlockStateProperty.builder(vexWart).fromProperties(StatePropertiesPredicate.Builder.newBuilder().withIntProp(VexwartBlock.AGE, 1))))
                .addEntry(ItemLootEntry.builder(item)
