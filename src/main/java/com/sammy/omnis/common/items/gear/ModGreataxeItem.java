...
public class ModGreataxeItem extends LodestoneAxeItem implements ITooltipItem, IEventResponderItem {
    ...
    public void addSneakTooltip(List<Component> tooltip) {
        tooltip.add(Component.translatable("omnis.tooltip.stunning_detailed").withStyle(ChatFormatting.BLUE));
    }

    @OnlyIn(Dist.CLIENT)
    @Override
    public void addDefaultTooltip(List<Component> tooltip) {
        tooltip.add(Component.translatable("omnis.tooltip.stunning").withStyle(ChatFormatting.BLUE));
    }
}
