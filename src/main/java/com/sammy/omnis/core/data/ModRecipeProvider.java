...
public class ModRecipeProvider extends RecipeProvider
{
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer)
    {
        ...
        ShapelessRecipeBuilder.shapelessRecipe(OmnisItems.HAUNTED_STEEL_INGOT.get()).addIngredient(Items.NETHERITE_SCRAP, 1).addIngredient(OmnisItems.TEAR_OF_VEX.get()).addIngredient(Items.GOLD_INGOT, 4).setGroup("haunted_steel").addCriterion("has_haunted_steel", hasItem(OmnisItems.HAUNTED_STEEL_INGOT.get())).build(consumer);
