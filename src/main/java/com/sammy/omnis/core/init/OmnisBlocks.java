...
public class OmnisBlocks
{
    ...
    public static final RegistryObject<Block> VEXWART = BLOCKS.register("vexwart", () -> new VexwartBlock(HEXWART_PROPERTIES().notSolid().doesNotBlockMovement().zeroHardnessAndResistance()));
