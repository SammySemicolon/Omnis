...
public class OmnisBlocks
{
    ...
    {
        return AbstractBlock.Properties.create(Material.ROCK, MaterialColor.ORANGE_TERRACOTTA).sound(OmnisSounds.RAVAGESTONE).hardnessAndResistance(1.25f,9f).setRequiresTool();
    }
