...
public class OmnisArmorTiers
{
    public enum ArmorTierEnum implements IArmorMaterial
    {

        RAVAGED_ARMOR("omnis:ravaged_armor", 25, new int[]{2, 6, 7, 3}, 14, () -> SoundEvents.ITEM_ARMOR_EQUIP_IRON, OmnisItems.RAVAGED_METAL, 2),
        HAUNTED_ARMOR("omnis:haunted_armor", 32, new int[]{3, 6, 8, 3}, 18, () -> SoundEvents.ITEM_ARMOR_EQUIP_IRON, OmnisItems.HAUNTED_STEEL_INGOT, 3);
