...
public class PotionRegistry
{
    ...
    public static final RegistryObject<Potion> MAGIC_PROFICIENCY = POTIONS.register("magic_proficiency", () -> new Potion("magic_proficiency", new EffectInstance(EffectRegistry.MAGIC_PROFICIENCY.get(), 3600)));
    public static final RegistryObject<Potion> LONG_MAGIC_PROFICIENCY = POTIONS.register("long_magic_proficiency", () -> new Potion("long_magic_proficiency", new EffectInstance(EffectRegistry.MAGIC_PROFICIENCY.get(), 9600)));
    public static final RegistryObject<Potion> STRONG_MAGIC_PROFICIENCY = POTIONS.register("strong_magic_proficiency", () -> new Potion("strong_magic_proficiency", new EffectInstance(EffectRegistry.MAGIC_PROFICIENCY.get(), 1800, 1)));
