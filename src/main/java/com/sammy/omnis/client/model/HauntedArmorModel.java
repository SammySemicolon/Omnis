...
public class HauntedArmorModel extends LodestoneArmorModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = helmet.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(52, 26).addBox(-13.5F, -32.0F, -4.0F, 6.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.5175F, 22.0F, 10.7057F, 0.0F, -0.7854F, 0.0F));
		PartDefinition head_r2 = helmet.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(52, 49).addBox(-11.5F, -32.0F, -4.0F, 6.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9175F, 22.0F, -2.7293F, 0.0F, 0.7854F, 0.0F));
